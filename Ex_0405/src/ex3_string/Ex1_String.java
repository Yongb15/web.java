...
// 일반적으로 문자열 데이터를 담는 간단한 형식으로 사용하지만 문자열을 처리하기 위한 다양한 기능들을 가지고 있다.
// String 객체는 한 번 생성되면 그 값을 읽기만 하고 변경할 수 없다.
...
public class Ex1_String {
	public static void main(String[] args) {
		...
		// lastIndexOf : 오른쪽부터 왼쪽으로 글자 탐색
		
		// charAt : 해당 위치의 글자 봔환
		System.out.println("5번 index의 값 : " + str.charAt(5));
		
		// substring : 내가 원하는만큼 문자열을 잘라냄
